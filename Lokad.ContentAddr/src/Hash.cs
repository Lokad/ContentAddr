...
public struct Hash : IEquatable<Hash>
{
    ...
    public Hash(string hex)
    {
        ...
        HashLeft = Convert.ToUInt64(hex[..16], 16);
        HashRight = Convert.ToUInt64(hex[16..], 16);
    }
    ...
    public static void PrintToSpan(Span<char> chars, Hash hash)
    {
        ...
        ToHex(chars[8..], (uint)hash.HashLeft);
        ToHex(chars[16..], (uint)(hash.HashRight >> 32));
        ToHex(chars[24..], (uint)hash.HashRight);

        static void ToHex(Span<char> span, uint ui)
        {
            Span<char> c = Chars;
    ...
    [Pure]
    public readonly int CompareTo(Hash other) =>
    ...
    /// <remarks> Reverse of <see cref="FromBytes(byte[])"/>. </remarks>     
    public readonly void ToBytes(Span<byte> span)
    {
        var a = HashLeft;
        var b = HashRight;
